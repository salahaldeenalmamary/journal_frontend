...
const PaddingAssignmentsReViewer = () => {
  const data = [
    {
      article_title: '',
      article_type: '',
  ...
  const rowActions = [
    ...
    {
      to: (item) => '/recommendationReviewer',
      label: "Submit Recommandation ",
      onClick: (item) => {
  ...
  return (
    <div>
      <h2>  <BackButton to="/reviews"  /> Padding Assignments Reviewer</h2>
      <Tables
        columns={columns}
...
export default PaddingAssignmentsReViewer;
